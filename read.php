		...
		?>
			...
			?>
				...
				<tr>
					...
					<td>
						<button type="button" class="btn btn-default"><a href="home.php?page=edit&id=<?php echo $m['id']; ?>"><i class="fa fa-pencil"></i> Edit </a></button>
						<button type="button" class="btn btn-danger"><a href="
         	  	  	   home.php? page=delete&id=<?php echo $m['id']; ?>" onclick="return confirm('Anda yakin mau menghapus Data ini ?')">Hapus<i class="fa fa-trash-o"></i></a></button>
					</td>
				</tr>
